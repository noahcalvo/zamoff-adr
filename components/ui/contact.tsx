  ...
  return(
    ...
    <div className="max-w-6xl mx-auto px-6">
      ...
      <div className="flex text-center justify-center gap-x-8">
        <div>
          <Mail className="w-8 h-8 mx-auto mb-5 text-blue-400" />
          <h3 className="text-lg font-semibold mb-2">Email</h3>
          <p className="text-gray-300">mitch@zamoffadr.com</p>
        </div>
        <div>
          <svg fill="#4aa6fb" width="100px" height="50px" viewBox="0 10 72 44" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" stroke="#000000" strokeWidth="0.00072"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>

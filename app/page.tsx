...
const experienceCards = [
  ...
  { icon: Award, title: "AAA Panelist", description: "Member of American Arbitration Association national, healthcare (featured panelist) and consumer arbitration panels and mediation panel" },
